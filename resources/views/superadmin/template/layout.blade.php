            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebar-menu">
                        ...
                        <li> <a href="{{URL('/superadmin/dashboard')}}" aria-expanded="false"><i class="fa fa-tachometer"></i><span>Dashboard</span></a>
                        </li>
                        <li class="nav-label">Users</li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Users</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('/superadmin/admin')}}">Admin</a></li>
                                <li><a href="{{URL('/superadmin/masyarakat')}}">Masyarakat</a></li>
                            </ul>
                        </li>
                        <li class="nav-label">Features</li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Features</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('/superadmin/pengaduan')}}">Pengaduan</a></li>
                                <li><a href="{{URL('/superadmin/berita')}}">Berita</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
